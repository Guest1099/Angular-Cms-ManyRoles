...
export class RejestratorLogowaniaService {
  ...
  public get(id: any): RejestratorLogowania {
    ...
    return this.rejestratorLogowania;
  }
  ...
  public create(userId: string): void {
    ...
    if (sessionModel) {
      ...
      if (sm) {
        ...
        this.http.post<any>(`${this.api}`, rejestratorLogowania).subscribe({
          next: ((result: TaskResult<RejestratorLogowania>) => {
            if (result.success) {
...
/*
  public edit(id: string, rejestratorLogowania: RejestratorLogowania): void {
    ...
    this.http.put<any>(`${this.api}/${id}`, object).subscribe({
      next: ((result: TaskResult<RejestratorLogowania>) => {
        if (result.success) {
          //this.getAll();
        } else {
